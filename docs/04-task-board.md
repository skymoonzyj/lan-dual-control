...
- [ ] Windows WGC 二进制帧 / H.264 硬编 / 轻量重复帧信令，以及 Mac client 真连观感验收。
- [ ] 安装包。
- [ ] 开机自启。
