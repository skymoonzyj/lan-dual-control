...
- Mac 端新增 `scripts/mac/observe-mac-video.mjs` 视频持续帧观察脚本；真机 H.264 3 秒收到 89 帧，约 29.2fps，最大接收间隔 42ms；JPEG 兜底 2 秒收到 37 帧，约 17.9fps，最大接收间隔 71ms。
