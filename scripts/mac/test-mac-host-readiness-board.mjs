...
function checkMediaBoardSummaryStatusFormatting() {
  ...
  assert(
    ...
    }) === "media=ok h264Key=2 sps=2 pps=2 idr=2 keyParam=2 firstKeyNal=7,8,5 lastKeyNal=7,8,5 lastNal=1 keyGapFramesMax=5 keyGapMsMax=167 keyTailFrames=1 keyTailMs=33",
    "media board summary should surface ok status, H.264 keyframe evidence, first/last NAL types, keyframe gaps, and tail gap",
  );
  assert(
    formatMediaBoardSummaryFixture({
      ...base,
