...
Options:
  ...
  --boardSummary          With --status, print a short secret-free Agent Link Board summary.
                          ...
                          command for H.264/WGC/WebCodecs capability checks.
